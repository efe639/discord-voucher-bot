...
module.exports = {
    ...
    name: "kadın",
    aliases: ["k"],
    description: "belirtlen kullanıcıyı kadın olarak kayıt eder.",
    permissions: [],
    category: ["Register"],
    active: true,
    ...
    */
    ...
    onRequest: async function (client, message, args, embed) {
        ...
        kayıtYap(member, message.member, isim, yaş, "kadın")
        ...
        if(isimveri.Isimler.length >= 1) { let messagesex = embed.setDescription(`${member} adlı üye başarılı bir şekilde Kadın olarak kaydedildi\n
        ...
        let messagesex2 = embed.setDescription(`${member} adlı üye başarılı bir şekilde Kadın olarak kayıt edildi.`)
